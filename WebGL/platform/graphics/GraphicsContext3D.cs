...
namespace WebGL
{
    ...
    public class GraphicsContext3D : IDisposable
    {
        ...
        public void framebufferTexture2D(UInt32 target, UInt32 attachment, UInt32 textarget, Platform3DObject texture, Int32 level)
        {
            this.makeContextCurrent();
