...
namespace WebGL
{
    ...
    public class Extensions3D
    {
        ...
        private GLX.PFNGLFRAMEBUFFERTEXTURE2DMULTISAMPLEIMG m_glFramebufferTexture2DMultisampleIMG;
        ...
        public Extensions3D(GraphicsContext3D context)
        {
            ...
            this.m_glFramebufferTexture2DMultisampleIMG = null;
        ...
        public void framebufferTexture2DMultisampleIMG(uint target, uint attachment, uint textarget, uint texture, int level, uint samples)
        {
            if (this.m_glFramebufferTexture2DMultisampleIMG != null)
            {
                this.m_glFramebufferTexture2DMultisampleIMG(target, attachment, textarget, texture, level, (int)samples);
            }
            else
            {
                this.m_context.synthesizeGLError(GLES.GL_INVALID_OPERATION);
        ...
        private bool supportsExtension(String name)
        {
            if (this.m_availableExtensions.Contains(name))
            {
                ...
                {
                    this.m_glFramebufferTexture2DMultisampleIMG = ReinterpretCast<GLX.PFNGLFRAMEBUFFERTEXTURE2DMULTISAMPLEIMG>(EGL.eglGetProcAddress("glFramebufferTexture2DMultisampleIMG"));
