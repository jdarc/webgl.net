...
namespace WebGL
{
    ...
    internal class WebGLTextureAttachment : WebGLAttachment
    {
        ...
        internal override void attach(GraphicsContext3D context, GLenum attachment)
        {
            ...
            context.framebufferTexture2D(GraphicsContext3D.FRAMEBUFFER, attachment, this.m_target, @object, this.m_level);
        }
        ...
        internal override void unattach(GraphicsContext3D context, GLenum attachment)
        {
            ...
            {
                context.framebufferTexture2D(GraphicsContext3D.FRAMEBUFFER, GraphicsContext3D.DEPTH_ATTACHMENT, this.m_target, 0, this.m_level);
                context.framebufferTexture2D(GraphicsContext3D.FRAMEBUFFER, GraphicsContext3D.STENCIL_ATTACHMENT, this.m_target, 0, this.m_level);
            }
            else
            {
                context.framebufferTexture2D(GraphicsContext3D.FRAMEBUFFER, attachment, this.m_target, 0, this.m_level);
            }
        }
