...
namespace WebGL
{
    ...
    internal class WebGLDrawBuffers : WebGLExtension
    {
        ...
        private static bool satisfiesWebGLRequirements(WebGLRenderingContext webglContext)
        {
            ...
            for (var i = 0; i < maxAllowedBuffers; ++i)
            {
                ...
                context.framebufferTexture2D(GraphicsContext3D.FRAMEBUFFER, (uint)(GraphicsContext3D.COLOR_ATTACHMENT0 + i), GraphicsContext3D.TEXTURE_2D, color, 0);
