...
namespace WebGL
{
    ...
    internal static class GLX
    {
        ...
        public delegate void PFNGLFRAMEBUFFERTEXTURE2DMULTISAMPLEIMG(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLsizei samples);
