...
namespace THREE
{
	public class Color
	{
		...
		public Color(dynamic value = null)
		{
			if (value != null)
			{
				this.set(value);
		...
		public void set(dynamic value = null)
		{
			if (value is string)
			{
		...
		public Color setRGB(double red, double grn, double blu)
		{
			r = red;
			g = grn;
			b = blu;
		...
		{
			r = System.Math.Sqrt(color.r);
			g = System.Math.Sqrt(color.g);
			b = System.Math.Sqrt(color.b);
		...
		public dynamic getHSV(double[] hsv = null)
		{
